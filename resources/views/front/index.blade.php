    ...
    <div class="row gx-4 gx-lg-5 justify-content-center">
        ...
        <div class="col-md-3">
            <div class="list-group">
                ...
                <a style="color: red" href="">Sabit Kategori Silebilirsiniz</a>
        ...
        <div class="col-md-10 col-lg-8 col-xl-7">
            ...
            <!-- Sabit İcerik Baslangic-->
            <div class="post-preview">
                <a>
                    <h2 style="color: red" class="post-title">Burası Sabit Başlıktır Silebilirsiniz</h2>
                    <h3 style="color: red" class="post-subtitle">Bu metin sayfa boş kalmasın diye yazılmıştır.Admin
                        panelinden içerik
                        ekleyince silebilirsiniz.</h3>
                    <!-- Divider-->
                    <hr class="my-4"/>
                    <p class="post-meta"></p>
                </a>
